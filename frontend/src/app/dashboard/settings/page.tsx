...
import { Settings, Key, Database, Loader2, CheckCircle2, UserPlus, Shield, Eye, Trash2, RotateCcw } from 'lucide-react';
  ...
  if (!isAdmin) {
    return (
      <div className="flex flex-col items-center justify-center h-64 text-center">
        ...
        <h2 className="text-lg font-medium text-white mb-2">Admin Only</h2>
        <p className="text-sm text-zinc-400">You need admin privileges to access settings.</p>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6 max-w-4xl">
      <div>
        ...
        <p className="text-sm text-zinc-400">Manage data, accounts, and platform configuration.</p>
      </div>
